/**
 * @description Migration file for dropping reset token and reset token
 * expiration from `users` table
 * @author Vo Tan Tai
 * @since 2025/12/19
 * @version 1.0.0
 */
...
export class RemoveResetTokenAndResetTokenExpirationInUsersTable1766135362057 implements MigrationInterface {

    /**
     * @description Migration run removing reset_token and
    ...
    /**
     * @description Migration revert adding reset_token and
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        /**
         * Check if `users` table not exist, skip migration
         */
        if (!usersTable) return;
