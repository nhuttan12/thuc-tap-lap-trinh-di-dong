    ...
    try {
      ...
      if (!productDetailEntity) {
        ...
        throw new BadRequestException({
          statusCode:
            ProductDetailStatusCode.PRODUCT_DETAIL_NOT_FOUND.statusCode,
          customCode:
            ProductDetailStatusCode.PRODUCT_DETAIL_NOT_FOUND.customCode,
          message: ProductDetailStatusCode.PRODUCT_DETAIL_NOT_FOUND.message,
        });
      }
      ...
      const productDetailResponseDto: ProductDetailResponseDto =
        this.productDetailMapper.toProductDetailResponse(productDetailEntity);
      this.logger.debug(
