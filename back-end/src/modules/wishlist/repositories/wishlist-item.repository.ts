        ...
        async (tx: EntityManager): Promise<WishlistItemEntity> => {
          ...
          if (!wishlistItemEntity) {
            ...
            throw new NotFoundException({
              statusCode: WishlistStatusCode.WishlistItemNotFound.statusCode,
              customCode: WishlistStatusCode.WishlistItemNotFound.customCode,
              message: WishlistStatusCode.WishlistItemNotFound.message,
            });
          }
